 ...
 * @dev Handles Guardian Owner Management Upgrade Management & Execution Call
 * @notice Authorizes an upgrade to new implementation
 * @dev Checks validity of new implementation before upgrade
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function __SecureSmartWalletBase_init(
        ...
        // Initialize with first owner as the Ownable owner
        __Ownable_init(_owners[0]);
