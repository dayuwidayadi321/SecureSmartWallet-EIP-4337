 ...
 * @dev Main & base contract that combines all wallet functionality through inheritance
 */
    ...
    ReentrancyGuardUpgradeable
{
    ...
    modifier onlyFactory() {
        require(msg.sender == factory, "SecureSmartWallet: caller is not factory");
        _;
    }    
    modifier onlyOwner() {
    ...
    function __SecureSmartWalletBase_init(
        ...
        require(_guardianThreshold > 0 && _guardianThreshold <= _guardians.length, 
            "SecureSmartWallet: invalid threshold");
    ...
    function _authorizeUpgrade(address newImplementation) internal virtual view {
        _validateOwnerOrGuardian();
    }
    ...
    function executeCall(
        ...
        uint256 gasLimit = gasleft() * 95 / 100;
    ...
    function _validateOwnerOrGuardian() internal view {
        require(
            isOwner[msg.sender] || _isActiveGuardian(msg.sender),
            "SecureSmartWallet: caller is not owner or guardian"
        );
    }
