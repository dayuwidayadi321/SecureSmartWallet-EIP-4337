...
contract SecureSmartWalletFactory {
    ...
    /**
     * @notice Deploy Smart Wallet baru
     * @param owners Daftar alamat owner (minimal 1)
     * @param guardians Daftar alamat guardian (bisa kosong)
     * @param guardianThreshold Jumlah minimal guardian untuk recovery
     * @return walletAddress Alamat wallet yang di-deploy
     */
    function deployWallet(
        ...
        require(guardianThreshold <= guardians.length, "Invalid threshold");
